...
<button type="button" on:click={() => (isOpen = !isOpen)} class="btn-white"> Toggle! </button>
					...
					>
						...
						<div class="flex gap-4 bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
							<button
								...
								class="mt-3 btn bg-red-500 text-white"
							>
								Deactivate
							</button>
							<button type="button" on:click={() => (isOpen = false)} class="mt-3 btn-white">
								Cancel
							</button>
						</div>
					</div>
